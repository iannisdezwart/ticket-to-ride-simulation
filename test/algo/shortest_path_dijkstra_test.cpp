...
class ShortestPathDijkstraTest : public Test {
protected:
...
TEST_F(ShortestPathDijkstraTest, EmptyMap) {
  auto p = shortestPathDijkstra(map, playerIdx, cityIdx("London"),
                                cityIdx("Berlin"));
...
TEST_F(ShortestPathDijkstraTest, PartOfRouteAlreadyPlacedOneSide) {
...
TEST_F(ShortestPathDijkstraTest, PartOfRouteAlreadyPlacedOneBothSides) {
  map.routes.claim[map.routeIdx("London", "Amsterdam")] = playerIdx;
...
TEST_F(ShortestPathDijkstraTest, PartOfRouteAlreadyPlacedInTheMiddle) {
...
TEST_F(ShortestPathDijkstraTest, OtherPlayerInTheWay1) {
...
TEST_F(ShortestPathDijkstraTest, OtherPlayerInTheWay2) {
